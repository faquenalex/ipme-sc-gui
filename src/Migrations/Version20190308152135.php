 ...
 */
final class Version20190308152135 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cached_element (id INT AUTO_INCREMENT NOT NULL, docker_name VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, date_update DATETIME DEFAULT NULL, date_created DATETIME DEFAULT NULL, serviceId INT DEFAULT NULL, INDEX IDX_21D266DA89697FA8 (serviceId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE cached_element');
